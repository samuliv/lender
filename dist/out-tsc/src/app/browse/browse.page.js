...
var BrowsePage = /** @class */ (function () {
    function BrowsePage(actionSheetController, extra) {
    ...
    BrowsePage.prototype.chooseLocationManually = function () {
        console.log('**CLICK**');
    };
    BrowsePage.prototype.someParameterChanged = function () {
        var _this = this;
        clearTimeout(this.refreshTimer);
        this.refreshTimer = setTimeout(function () { _this.refreshBrowseItemsCount(); }, 250);
    };
    BrowsePage.prototype.refreshBrowseItemsCount = function () {
        console.log('***REFRESH BROWSE ITEM COUNT***');
        // TODO
        this.browseItemsCount = Math.floor(Math.random() * 100).toString();
    };
    BrowsePage.prototype.quickSearch = function () {
    ...
    BrowsePage.prototype.ionViewDidEnter = function () {
    ...
    BrowsePage = __decorate([
        ...
        __metadata("design:paramtypes", [ActionSheetController, ExtraService])
    ], BrowsePage);
    return BrowsePage;
}());
export { BrowsePage };
